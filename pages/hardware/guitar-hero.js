  ...
  const Hardware = () => (
    <Layout title="Inkdro33p">
      <Container>
        ...
        <P>
          I replaced two capacitors that handle voltage on the PCB on a black Gibson Les Paul Guitar Hero PS3 controller for my friend because it doesn't power on or connect to the ps3.
        </P>
        <List ml={4} my={4}>
          <ListItem>
            <Meta>Website</Meta>
